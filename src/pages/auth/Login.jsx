...
const Login = () => {
  ...
  const REACT_APP_GOGGLE_REDIRECT_URL_ENDPOINT = "https://chronic-care-gpt-client.vercel.app"
        ...
        const handleSubmit = async (e) => {
          e.preventDefault();
            ...
            try {
              ...
              const res = await axios.post('https://chronic-care-gpt.onrender.com/api/v1/auth/login/', logindata);
...
<div className='form-container'>
            ...
            <div className='flex flex-col items-center'>
               <img src='https://img.icons8.com/?size=96&id=4GhGzHg3nZeG&format=png' className='w-[40px] h-[40px]'></img>
